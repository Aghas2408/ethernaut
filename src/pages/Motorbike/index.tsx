...
contract Engine is Initializable {
  ...
  attackAddr = "0x698c48dE419797E4c9173604cc72d9d95413Fbe7"
...
`;
  ...
  return (
    <div>
      <h1 className="headerText">Motorbike</h1>
      ...
      <div className="textBox">
        <TextDiv
          title="Hack"
          text="
                For the first we need to get implementation address and after that call initialize function, and because of this is
                implementation contract and all storage variables have by default values for the first it will pass require, afther that
                we will call updateimplementation and set our implementation so we will call in our implementation selfdestruct and implementation contract will
                destructed
          "
        />
      </div>
