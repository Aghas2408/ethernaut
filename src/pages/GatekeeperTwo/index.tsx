...
contract GatePassTwoAttack {
  ...
  return (
    <div>
      <h1 className="headerText">GatekeeperTwo</h1>
      ...
      <div className="textBox">
        <TextDiv
          ...
          In the second one check, it uses excodesize, and for contracts, it can't be zero, but befoure contract will deployed, it means in constructor it is zero.
          In the third check it use X ^ Y = Z
          It means Y = X ^ Z
          So becouse of attacker contract is msg.sender 
          there key will equal to
          bytes8 key = bytes8(uint64(bytes8(keccak256(abi.encodePacked(address(this))))) ^ uint64(0xffffffffffffffff))
          "
        />
      </div>
